...
-- Behind = ติดหลัง / Above = นอนราบบนหัว (ไม่กลับหัว)
...
Tabs.Farm:AddDropdown("TeleportModeDD", {
    ...
    Description = "Behind = ติดหลัง  /  Above = นอนราบบนหัว",
    Values      = { "Behind", "Above" },
    Default     = "Behind",
...
SaveManager:SetIgnoreIndexes({ "AutoFarmToggle", "LoopWalkSpeed" })
